cmd_arch/arm/dts/imx8-deneb.dtb := mkdir -p arch/arm/dts/ ; (cat arch/arm/dts/imx8-deneb.dts; ) > arch/arm/dts/.imx8-deneb.dtb.pre.tmp;  cc -E -Wp,-MD,arch/arm/dts/.imx8-deneb.dtb.d.pre.tmp -nostdinc -I./arch/arm/dts -I./arch/arm/dts/include -Iinclude -I./include -I./arch/arm/include -include ./include/linux/kconfig.h -D__ASSEMBLY__ -undef -D__DTS__ -x assembler-with-cpp -o arch/arm/dts/.imx8-deneb.dtb.dts.tmp arch/arm/dts/.imx8-deneb.dtb.pre.tmp ; ./scripts/dtc/dtc -O dtb -o arch/arm/dts/imx8-deneb.dtb -b 0 -i arch/arm/dts/ -Wno-unit_address_vs_reg -Wno-unit_address_format -Wno-avoid_unnecessary_addr_size -Wno-alias_paths -Wno-graph_child_address -Wno-graph_port -Wno-unique_unit_address -Wno-simple_bus_reg -Wno-pci_device_reg -Wno-pci_bridge -Wno-pci_device_bus_num  -@ -a 0x8 -Wno-unit_address_vs_reg -Wno-unit_address_format -Wno-avoid_unnecessary_addr_size -Wno-alias_paths -Wno-graph_child_address -Wno-graph_port -Wno-unique_unit_address -Wno-simple_bus_reg -Wno-pci_device_reg -Wno-pci_bridge -Wno-pci_device_bus_num  -@ -d arch/arm/dts/.imx8-deneb.dtb.d.dtc.tmp arch/arm/dts/.imx8-deneb.dtb.dts.tmp || (echo "Check /home/valentin/workspace/uboot-imx/arch/arm/dts/.imx8-deneb.dtb.pre.tmp for errors" && false) ; sed "s:arch/arm/dts/.imx8-deneb.dtb.pre.tmp:arch/arm/dts/imx8-deneb.dts:" arch/arm/dts/.imx8-deneb.dtb.d.pre.tmp arch/arm/dts/.imx8-deneb.dtb.d.dtc.tmp > arch/arm/dts/.imx8-deneb.dtb.d

source_arch/arm/dts/imx8-deneb.dtb := arch/arm/dts/imx8-deneb.dts

deps_arch/arm/dts/imx8-deneb.dtb := \
...
arch/arm/dts/imx8-deneb.dtb: $(deps_arch/arm/dts/imx8-deneb.dtb)
